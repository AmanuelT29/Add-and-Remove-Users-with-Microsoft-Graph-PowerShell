...
2. I verified the successful removal of the users by running the `Get-MgUser` command and checking the **Deleted Users** section in my Microsoft Entra ID portal to ensure the accounts were no longer listed:
